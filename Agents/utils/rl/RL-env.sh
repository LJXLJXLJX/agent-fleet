...
RL_ASYNC_TRIAL_BATCHES_ENABLED="${RL_ASYNC_TRIAL_BATCHES_ENABLED:-0}"
RL_ASYNC_TRIAL_REGISTRY_PATH="${RL_ASYNC_TRIAL_REGISTRY_PATH:-${RL_QUEUE_DIR}/async-trial-registry.sqlite3}"
RL_ASYNC_MAX_TRIALS_PER_BATCH="${RL_ASYNC_MAX_TRIALS_PER_BATCH:-256}"
RL_ASYNC_MAX_REQUEST_BYTES="${RL_ASYNC_MAX_REQUEST_BYTES:-33554432}"
RL_ASYNC_MAX_BULK_STATUS_IDS="${RL_ASYNC_MAX_BULK_STATUS_IDS:-128}"
export RL_ASYNC_TRIAL_BATCHES_ENABLED RL_ASYNC_TRIAL_REGISTRY_PATH RL_ASYNC_MAX_TRIALS_PER_BATCH
export RL_ASYNC_MAX_REQUEST_BYTES RL_ASYNC_MAX_BULK_STATUS_IDS
